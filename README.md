# Intro
The code here is pretty much everything I use to create my visuals. Currently only including code used to create my tables using Soccerment data but will be adding code that I use to create other visuals using Fbref and Statsbomb data.
